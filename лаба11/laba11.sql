...
select count (Property_no) From Property group by City having  City='Витебск' or City = 'Полоцк';
...
select avg(Selling_Price) from Property where Rooms = 3 and Balcony ='Б';
